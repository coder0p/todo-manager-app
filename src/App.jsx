      ...
      <div className="app">
         ...
         <div className="headings">
            <div className="mainHeading">
               <h1 className="gradient-text">ToDo Manager</h1>
            </div>
         ...
         <form onSubmit={handleInputSubmit}>
            <div className="toDoInput">
               <div className="left">
                  <input value={toDo} onChange={handleUserInput} type="text" placeholder=" Add Task . . ." />
               </div>
                     ...
                     return (
                        <div key={obj.id} className="toDo">
                           ...
                           <div className="right bin">
                              <i onClick={(e) => {
                                 let isdelete = window.confirm("Do you want to Delete ToDo permanently?");
                                 if (isdelete) {
                                    e.target.value = true;
                                 }
            ...
            <h3>Dropped</h3>
            {
               toDos && toDos.map((obj) => {
                  if (obj.statusDrop && !obj.statusRetrieve && !obj.statusRemove) {
                     return (
                        //recycling the task that removed
                        <div key={obj.id} className="toDo">
                           <div className="left recycle">
                              <i onClick={(e) => {
                                 let isdelete = window.confirm("Do you want to Retrive what you dropped?");
                                 if (isdelete) {
                                    e.target.value = true;
                                 }
                                 setToDos(toDos.filter((obj2) => {
                              ...
                              }} value={obj.statusRetrieve} className="fas fa-redo-alt" title="Recycle"></i>
                           </div>
                           <div className="top">
                              <p className="textCross">{obj.text}</p>
                           </div>
                           ...
                           <div className="right bin">
                              <i onClick={(e) => {
                                 //deleting todo task for permanently 
                                 let isdelete = window.confirm("This will delete toDo permanently !");
                                 if (isdelete) {
                                    e.target.value = true;
                                 }
                                 setToDos(toDos.filter((obj2) => {
